function renderPosts(posts) {
    ...
    let postHTML = "<section class='articles'>";
        ...
        postHTML += `
                <article>
                    ...
                    <div class="article-body">
                        <div class= "head-artical">
                            <div>
                                <img src="/images/user.jpg" class="user-icon" alt="user-icon"> 
                                <a >${post.author.username}</a>
                            </div>
                            <p class="create-at">${new Date(post.createdAt).toLocaleString("en-US", { 
                            hour: "2-digit", 
                            minute: "2-digit", 
                            second: "2-digit",
                            hour12: true 
...
module.exports = {renderPosts,renderPost};
